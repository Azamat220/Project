...
async function initializeDatabase() {
  ...
  try {
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS conversations_3 (
    ...
    // Create indexes
    await client.query(`
      CREATE INDEX IF NOT EXISTS idx_user_id ON conversations_3 (user_id);
      CREATE INDEX IF NOT EXISTS idx_timestamp ON conversations_3 (timestamp);
    `);

    // Create products table
    await client.query(`
      CREATE TABLE IF NOT EXISTS products_3 (
        id SERIAL PRIMARY KEY,
        name TEXT NOT NULL,
        price TEXT,
        image TEXT,
    ...
    await client.query(`
      ...
      ON products_3 USING hnsw (embedding vector_cosine_ops);
    `);
